...
public class HomePageLocatorsAlm extends BaseClass{
	
	@FindBy(css="button[data-testid='Header__LanguageSwitch']")
	public WebElement drpDownLangSelector;
	
	@FindBy(linkText="English")
	public WebElement langSelectorEng;
	...
	@FindBy(css="div[class='sc-1sn5k4t-3 dTWLLG']")
